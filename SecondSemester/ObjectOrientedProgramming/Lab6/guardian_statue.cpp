 ...
 * \param power_word_name the power word name of the GuardianStatue
 * \param material the material of the GuardianStatue
 * \param age the age of the GuardianStatue
 * \param corporeal_form the corporeal form of the GuardianStatue
 */
GuardianStatue::GuardianStatue(std::string power_word_name, std::string material, int age, std::string corporeal_form) {
    this->power_word_name_ = std::move(power_word_name);
    this->material_ = std::move(material);
    this->age_ = age;
    this->corporeal_form_ = std::move(corporeal_form);
}
 ...
 * \param corporeal_form the new value for the corporeal form of the object
 */
void GuardianStatue::set_corporeal_form(std::string corporeal_form) {
    this->corporeal_form_ = std::move(corporeal_form);
}
 ...
 * \param other_statue the second object passed as a const reference
 * \return true if equal, else false
 */
bool GuardianStatue::operator==(GuardianStatue const&other_statue) const {
    return power_word_name_ == other_statue.power_word_name_ && material_ == other_statue.material_ && age_ == other_statue.age_ && corporeal_form_ == other_statue.corporeal_form_;
}
 ...
 */
bool GuardianStatue::operator!=(GuardianStatue const &other_statue) const {
    return !(other_statue == *this);
}

/**
 * \brief assigns a new value to the entire object
 * \param other_statue the new value of the object
 * \return reference to this
 */
GuardianStatue& GuardianStatue::operator=(GuardianStatue const &other_statue) {
    if (this == &other_statue) {
        return *this;
    }
    power_word_name_ = other_statue.power_word_name_;
    material_ = other_statue.material_;
    age_ = other_statue.age_;
    corporeal_form_ = other_statue.corporeal_form_;
    return *this;
}
