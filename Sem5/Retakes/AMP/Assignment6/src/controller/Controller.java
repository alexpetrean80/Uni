...
public class Controller {
    ...
    public List<Integer> getAllAddresses(List<Integer> symbolTableAddresses, Map<Integer, Value> heap) {
        ...
        var foundAllAddresses = false;
        var allAddresses = new ArrayList<>(symbolTableAddresses);
        ...
        var addrAndRefValues = entrySet.stream()
                ...
                .map(pair -> {
                    RefValue value = (RefValue) pair.getValue();
    ...
    List<Integer> getAllStatesAddresses(List<ProgramState> programStateList) {
        var allAddresses = new ArrayList<Integer>();
    ...
    public void typeCheckOriginalProgram() {
        Dict<String, Type> typeEnvironment = new TLDict<String, Type>();
