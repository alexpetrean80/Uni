...
public record View(IController ctrl, Scanner scanner) implements IView {
    ...
    private VehicleType getType() {
        return switch (scanner.nextInt()) {
            ...
            default -> throw new CustomException("Invalid vehicle type.");
        };
    }
    ...
    private AddVehicleMenuOption getAddVehicleUserOption() {
        return switch (scanner.nextInt()) {
            ...
            default -> throw new CustomException("Invalid option.");
        };
    }
