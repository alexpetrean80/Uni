...
public class Controller {
   ...
   public void allStepsExecution(){
    ...
    public void oneStepForAllPrograms(List<ProgramState> programStateList){
        ...
        List<Callable<ProgramState>> callableList = callableList = programStateList.stream()
    ...
    public void typeCheckOriginalProgram(){
        IDictionary<String, Type> typeEnvironment = new MyDictionary<String, Type>();
        Statement originalProgram =  this.repository.getOriginalProgram();
    ...
    public String toString(){
        return this.repository.getOriginalProgram().toString();
    }

    public void evaluateOneStepForAll(List<ProgramState> programStateList){

        this.garbageCollectorAllProgramStates(programStateList);
        this.oneStepForAllPrograms(programStateList);
        this.repository.setProgramList(this.removeCompletedPrograms(programStateList));
