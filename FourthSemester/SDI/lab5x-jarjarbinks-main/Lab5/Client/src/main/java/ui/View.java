...
public class View {
    ...
    private final DroidRpcService ctrl;
    private final ClientRpcService cs;
    private final PurchaseRpcService ps;
    private final ReceiptRpcService rs;
     ...
     * @param rs
     */
    public View(DroidRpcService dr,ClientRpcService cs,PurchaseRpcService ps, ReceiptRpcService rs) {
        this.cs = cs;
        this.ctrl = dr;
        this.rs = rs;
        this.ps = ps;
    ...
    private void updateAClient() throws ValidatorException {
        ...
        try {
            ...
            cs.updateClient(id,name,address,phoneNumber);
        } catch (IOException ex) {
            System.out.println("Line does not exist.");
        }catch(IllegalArgumentException e){
            System.out.println("Not a valid type.");
    ...
    private void addAClient() {
        ...
        try {
            ...
            cs.addClient(name,address,phoneNumber);
        } catch (IOException ex) {
            System.out.println("Line does not exist.");
        }catch(IllegalArgumentException e){
            System.out.println("Not a valid type.");
    ...
    private void filterDroidsByMinimumPowerUsage(){
        System.out.println(ctrl.getDroidsByFilter(3));
    }
    ...
    private void addADroid() throws ValidatorException {
        ...
        try {
            ...
            ctrl.addDroid(powerUsage,price,batteryTime,model,driver);
        } catch (IOException ex) {
            System.out.println("Line does not exist.");
        }catch(IllegalArgumentException e){
            System.out.println("Not a valid type.");
    ...
    private void updateADroid() throws ValidatorException {
        ...
        try {
            ...
            ctrl.updateDroid(id,powerUsage,price,batteryTime,model,driver);
        } catch (IOException ex) {
            System.out.println("Line does not exist.");
        }catch(IllegalArgumentException e){
            System.out.println("Not a valid type.");
